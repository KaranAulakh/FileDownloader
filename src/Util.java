...
public class Util {
    public static final Map.Entry<String, String>[] recipes = new Map.Entry[] {
    ...
    public static final Map.Entry<String, String>[] guitars = new Map.Entry[]{
    ...
    public static Map.Entry<String, String>[] getDownloads(String typeOfDownload){
